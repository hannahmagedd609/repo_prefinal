...
constexpr auto qt_meta_stringdata_CLASSregister_DialogENDCLASS = QtMocHelpers::stringData(
    "register_Dialog",
    "on_newName_textChanged",
    "",
    "arg1",
    "on_newPassword_textChanged",
    "on_btn2_reg_clicked"
);
...
Q_CONSTINIT const QMetaObject register_Dialog::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSregister_DialogENDCLASS_t,
        ...
        // method 'on_newName_textChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'on_newPassword_textChanged'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        QtPrivate::TypeAndForceComplete<const QString &, std::false_type>,
        // method 'on_btn2_reg_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void register_Dialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->on_newName_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_newPassword_textChanged((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->on_btn2_reg_clicked(); break;
        default: ;
        }
    }
}
