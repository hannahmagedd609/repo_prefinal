...
struct qt_meta_stringdata_CLASSgameWindow1ENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSgameWindow1ENDCLASS = QtMocHelpers::stringData(
    "gameWindow1",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSgameWindow1ENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject gameWindow1::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSgameWindow1ENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSgameWindow1ENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSgameWindow1ENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<gameWindow1, std::true_type>,
...
void *gameWindow1::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSgameWindow1ENDCLASS.stringdata0))
